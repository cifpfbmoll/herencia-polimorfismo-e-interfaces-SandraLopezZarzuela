...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Libro l1 = new Libro(1234, "El Libro", "Librero", "Libreria", 15, 5);
        Bibliotecario b1 = new Bibliotecario("ADMIN", 1234, "ADMIN", "ADMIN", "ADMIN", "ADMIN", 99);
        Usuario u1 = new Usuario(666999666, "DIRECCION", 07000, "CORREO", "NOMBRE", "APELLIDO1", "APELLIDO2", 21);
        bib.getListaLibros().add(l1);
        bib.getListaPersonas().add(b1);
        bib.getListaPersonas().add(u1);
        while (seguir) {
